...
public class TenJudge {
    ...
    public static void doJudge() {
        ...
        int x1 = random.nextInt(10)%(11);
        int y1 = random.nextInt(10)%(11);
        m_right1 = x1 + y1;

        int x2 = random.nextInt(10)%(11);
        int y2 = random.nextInt(10)%(11);
        m_right2 = x2 + y2;

        int x3 = random.nextInt(10)%(11);
        int y3 = random.nextInt(10)%(11);
        m_right3 = x3 + y3;
        ...
        int x7 = random.nextInt(10)%(11);
        int y7 = random.nextInt(10)%(11);
        m_right7=x7*y7;

        int x8 = random.nextInt(10)%(11);
        int y8 = random.nextInt(10)%(11);
        m_right8 = x8 * y8;

        int x9 = random.nextInt(10)%(10) + 1;
        int times9 = random.nextInt(10)%(10) + 1;
