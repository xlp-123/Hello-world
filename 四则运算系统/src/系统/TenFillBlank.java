...
public class TenFillBlank {
    ...
    public static void doFillBlank() {
        ...
        int x4 =random.nextInt(10)%(11);
        int y4 = random.nextInt(10)%(11);
        m_right4 = x4 - y4;

        int x5 =random.nextInt(10)%(11);
        int y5 = random.nextInt(10)%(11);
        m_right5 = x5 - y5;

        int x6 = random.nextInt(10)%(11);
        int y6 = random.nextInt(10)%(11);
        m_right6=x6*y6;
        ...
        int x10 = random.nextInt(10)%(11)+1;  //x10为10到20之间的整数
        int times10 = random.nextInt(10)%(11) + 1; //times10代表10到30倍
        ...
        textField_question0.setText(" " + String.valueOf(x1) + " + " + String.valueOf(y1 ) + "  = ");
        ...
        textField_question1.setText(String.valueOf(x2) + " + " + String.valueOf(y2) + " = ");
        ...
        textField_question2.setText(String.valueOf(x3) + "+" + String.valueOf(y3) + " = ");
        ...
        textField_question3.setText(" " + String.valueOf(x4) + " - " + String.valueOf(y4) + " = ");
        ...
        textField_question4.setText(String.valueOf(x5) + " - " + String.valueOf(y5) + " = ");
        ...
        textField_question5.setText(" " + String.valueOf(x6) + " × " + String.valueOf(y6) + "  = ");
        ...
        textField_question6.setText(String.valueOf(x7) + " × " + String.valueOf(x7) + " = ");
        ...
        textField_question7.setText(String.valueOf(x8) + " × " + String.valueOf(y8) + " = ");
        ...
        textField_question8.setText(" " + String.valueOf(x9) + " ÷ " + String.valueOf(y9) + " = ");
        ...
        textField_question9.setText(" " + String.valueOf(x10) + "÷" + String.valueOf(y10) + " = ");
        ...
        button_submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (textField_answer0.getText().equals(String.valueOf(x1+y1 ))) {m_score ++; textField_judge0.setText("√"); }
                else {textField_judge0.setText("×");}
                m_right0 = x1  + y1;

                if (textField_answer1.getText().equals(String.valueOf(x2+y2))) {m_score ++; textField_judge1.setText("√"); }
                else {textField_judge1.setText("×");}
                m_right1 = x2+y2;

                if (textField_answer2.getText().equals(String.valueOf(x3+y3))) {m_score ++; textField_judge2.setText("√"); }
                else {textField_judge2.setText("×");}
                m_right2 = x3+y3;

                if (textField_answer3.getText().equals(String.valueOf(x4-y4))) {m_score ++; textField_judge3.setText("√"); }
                else {textField_judge3.setText("×");}
                m_right3 = x4-x5;

                if (textField_answer4.getText().equals(String.valueOf(x5-y5))) {m_score ++; textField_judge4.setText("√"); }
                else {textField_judge4.setText("×");}
                m_right4 = x5- y5;

                if (textField_answer5.getText().equals(String.valueOf(x6*y6))) {m_score ++; textField_judge5.setText("√"); }
                else {textField_judge5.setText("×");}
                m_right5 =x6*y6;

                if (textField_answer6.getText().equals(String.valueOf(x7*y7))) {m_score ++; textField_judge6.setText("√"); }
                else {textField_judge6.setText("×");}
                m_right6 = x7*y7;

                if (textField_answer7.getText().equals(String.valueOf(x8*y8))) {m_score ++; textField_judge7.setText("√"); }
                else {textField_judge7.setText("×");}
                m_right7 = x8*y8;
                DecimalFormat df = new DecimalFormat("#.00");

                if (textField_answer8.getText().equals(String.valueOf(x9/y9))) {m_score ++; textField_judge8.setText("√"); }
                else {textField_judge8.setText("×");}
                m_right8 = x9/y9 ;

                if (textField_answer9.getText().equals(String.valueOf( x10/y10))) {m_score ++; textField_judge9.setText("√"); }
